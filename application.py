...
def main():
  ...
  with row_2_1:
    ...
    fig_bar_lifespan = st.plotly_chart(
      ...
      title='Duration on Market by Currency',hover_data=['First Day','Last Day'],
  ...
  with row_3_1:
    ...
    fig_line_cap = st.plotly_chart(
      ...
      color='Name', width=1100, height=600,
  ...
  with row_8_1:
    ...
    fig_bubble_volume = st.plotly_chart(
      ...
      size='Volume',color='Name',log_x=True,log_y=True,
  ...
  with row_10_1:
    ...
    fig_line_volume_price = st.plotly_chart(
      ...
      height=500,width=1000,log_y=True)
    )
